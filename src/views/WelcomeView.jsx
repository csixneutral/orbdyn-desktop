...
export function WelcomeView({ setupNeeded, orgName, onGetStarted, onSignIn }) {
  return (
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-10">
          ...
          <div className="max-w-xl space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">
              {setupNeeded ? (
                ...
                <Button size="lg" className="gap-2" onClick={onSignIn}>
                  Sign in to {orgName || 'your team'}
                  <ArrowRight className="h-4 w-4" />
                </Button>
              )}
              {setupNeeded && (
        ...
        <footer className="text-center">
          <TypographyMuted className="text-xs">Sign in after setup to create projects and invite your team.</TypographyMuted>
        </footer>
      </div>
    </div>
  );
